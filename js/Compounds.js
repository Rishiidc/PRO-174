AFRAME.registerComponent("atoms", {
    ...
    createAtoms: async function(){
        ...
        var color = await this.getElementsColor();
        ...
        var atoms = document.createElement("a-entity");
        atoms.setAttribute("id",`${elementName}-${barcodeValue}`);
        marker.appendChild(atoms);
